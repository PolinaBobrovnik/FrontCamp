...
var Controller = function () {
  ...
  _createClass(Controller, [{
    ...
    key: 'toggleSearchButton',
    value: function toggleSearchButton() {
    ...
    value: function onSearchInputChange(event) {
      var searchedSourcesNames = this.model.sourcesNames.filter(function (sourceName) {
        return sourceName.toLowerCase().indexOf(event.target.value.toLowerCase()) === 0;
      });
      this.view.createAutosuggest(searchedSourcesNames);
    }
  }, {
    key: 'onSearchInputSubmit',
    value: function onSearchInputSubmit(event) {
      if (!event.keyCode || event.keyCode && event.keyCode === 13) {
    ...
    key: 'selectPublisher',
    value: function selectPublisher(event) {
      var source = event.target.dataset.source;
      if (source) {
        this.view.onSearchInputSubmit();
        this.model.setSourceId(source);
        this.requestData({ publisher: this.model.sourceId, numberOfRecords: this.model.numberOfRecords });
      }
    }
  }, {
    key: 'requestData',
    value: function requestData(_ref) {
      var _this = this;
      ...
      fetch(req).then(function (response) {
        ...
        _this.view.createArticles(result.articles);
        _this.model.setNumberOfRecords(result.articles.length);
      });
    }
  }, {
    key: 'requestSources',
    value: function requestSources() {
      var _this2 = this;
      ...
      fetch('https://newsapi.org/v2/sources?apiKey=2a878fc593044fdba0c5153f9a2a46e7').then(function (res) {
        ...
        return sources.forEach(function (source) {
          _this2.model.setSourcesName(source);
        });
      });
    }
  }]);
...
var App = function () {
  ...
  _createClass(App, [{
    ...
    value: function startListen() {
      debugger;
      (0, _util.$on)(this.controller.view.categories, 'click', this.controller.selectCategory.bind(this.controller));
      (0, _util.$on)(this.controller.view.settings, 'submit', this.controller.preventDefault.bind(this.controller));
      (0, _util.$on)(this.controller.view.toggle, 'click', this.controller.toggleTopHeadlines.bind(this.controller));
      (0, _util.$on)(this.controller.view.numberInput, 'blur', this.controller.onNumberInputChange.bind(this.controller));
      (0, _util.$on)(this.controller.view.numberInput, 'keypress', this.controller.onNumberInputChange.bind(this.controller));
      (0, _util.$on)(this.controller.view.searchButton, 'click', this.controller.toggleSearchButton.bind(this.controller));
      (0, _util.$on)(this.controller.view.menuIcon, 'click', this.controller.toggleMenu.bind(this.controller));
      (0, _util.$on)(this.controller.view.searchInput, 'input', this.controller.onSearchInputChange.bind(this.controller));
      (0, _util.$on)(this.controller.view.searchSubmit, 'click', this.controller.onSearchInputSubmit.bind(this.controller));
      (0, _util.$on)(this.controller.view.autosuggest, 'click', this.controller.selectPublisher.bind(this.controller));
    }
  }, {
    key: 'init',
    value: function init() {
...
var Model = function () {
    ...
    _createClass(Model, [{
        ...
        key: 'setNumberOfRecords',
        value: function setNumberOfRecords(numberOfRecords) {
            this.numberOfRecords = numberOfRecords;
        }
    }, {
        key: 'setSourcesName',
        value: function setSourcesName(source) {
        ...
        key: 'setSourceId',
        value: function setSourceId(source) {
            var sourceId = this.sourcesNameToId.get(source);
...
exports.newSourceName = exports.noData = exports.clearfix = exports.article = undefined;
...
var newSourceName = function newSourceName(sourceName) {
...
exports.newSourceName = newSourceName;
  ...
  _createClass(View, [{
    ...
    value: function createArticles(articles) {
      ...
      articles.forEach(function (element) {
        _this.mainContent.appendChild((0, _template.article)(element));
      });
      this.mainContent.appendChild((0, _template.clearfix)());
    }
  }, {
    key: 'showTopHeadlinesFilter',
    value: function showTopHeadlinesFilter(isShown) {
      isShown ? this.topHeadlinesFilter.classList.remove("hidden") : this.topHeadlinesFilter.classList.add("hidden");
    }
  }, {
    key: 'createAutosuggest',
    value: function createAutosuggest(sourceNames) {
      var _this2 = this;
      ...
      if (sourceNames.length === 0) {
        this.autosuggest.appendChild((0, _template.noData)());
      } else {
        sourceNames.forEach(function (sourceName) {
          _this2.autosuggest.appendChild((0, _template.newSourceName)(sourceName));
        });
      }
    ...
    key: 'onSearchInputSubmit',
    value: function onSearchInputSubmit() {
